    ...
    internal class Client_Selection_View01
    {
        ...
        private void load_Client_Selection_View01()
        {
            ...
            data01[0] = $"1.)sql client\n" +
                        ...
                        $"22.) find_client_cashapp_by_name\n" +
                         $"23.)find_client_cashapp_by_phonenumber\n" +
 $"24.)find_client_cashapp_by_email\n" +
 $"25.)find_client_data01_by_email\n" +
 $"26.)find_client_data01_by_name\n" +
 $"27.)find_client_data01_by_phonenumber\n" +
 $"28.)find_client_zelle_by_email\n" +
 $"29.)find_client_zelle_by_name\n" +
 $"30.)find_client_zelle_by_phonenumber\n" +
                        $"31.) go back\n";
                        ...
                        switch (int.Parse(data01[1]))
                        {
                                        ...
                                        if (Security_Serv01.empty_string(data01[5]) == true)
                                        {
                                            ...
                                            if (Security_Serv01.empty_string(data01[6]) == true)
                                            {
                                                if (Security_Serv01.email_check(data01[6]) == true)
                                                {
                                                    ...
                                                    {
                                                        data01[22] = "Input can not be empty. Please try again.";
                                                        Console.WriteLine(data01[22]);
                                                        data01[7] = Console.ReadLine() ?? string.Empty;
                                                        continue;
                                                ...
                                                {
                                                    data01[22] = "Input must be only email formated. Please try again.";
                                                    Console.WriteLine(data01[22]);
                                                    data01[6] = Console.ReadLine() ?? string.Empty;
                                                    continue;
                            ...
                            case 22:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_cashapp_by_name(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 23:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_cashapp_by_phonenumber(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 24:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_cashapp_by_email(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 25:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_data01_by_email(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 26:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_data01_by_name(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 27:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_data01_by_phonenumber(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 28:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_zelle_by_email(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 29:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_zelle_by_name(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
                            ...
                            case 30:
                                ...
                                if (Security_Serv01.empty_string(data01[3]) == true)
                                {
                                    ...
                                    if (Sql_Client_S01.find_client_zelle_by_phonenumber(data01[3], out resaults) == true)
                                    {
                                        data01[22] = resaults;
                                        Console.WriteLine(data01[22]);
                                        data01[3] = Console.ReadLine() ?? string.Empty;
