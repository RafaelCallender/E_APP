...
using E_APP.VIEW.MOVIES_VIEW.MOVIES_MAIN_VIEW;
using System;
using System.Collections.Generic;
using System.Text;

namespace E_APP.VIEW.MOVIES_VIEW.MOVIES_SELECTION_VIEW
{
    internal class Movies_Selection_View01
    {
            ...
            while (true)
            {
                ...
                if (Security_Serv01.empty_string(data01[1]) == true)
                {
                    if (Security_Serv01.string_only_digit(data01[1]) == true)
                    {
                        ...
                        {
                            case 1:
                                Console.WriteLine("not developed yet");
                                return;
                            case 2:
