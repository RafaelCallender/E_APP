...
using E_APP.VIEW.NEWS_VIEW.NEWS_SELECTION_VIEW;


namespace E_APP.VIEW.NEWS_VIEW.NEWS_MAIN
{
    internal class News_Main_View01
    {
        ...
        {
            load_News_Main_View01();
        }
        private void load_News_Main_View01()
        {
