...
namespace E_APP.SERVICES.FILE_SERVICES.TEXT_FILES
{
    internal class Read_Textfiles
    {
        ...
        private static Stream[] stream01 = { assembly.GetManifestResourceStream(file_helper[0]),
                                             ...
                                             assembly.GetManifestResourceStream(file_helper[11]),
                                             assembly.GetManifestResourceStream(file_helper[12]),
                                              assembly.GetManifestResourceStream(file_helper[13]),
        ...
        private static StreamReader[] reader01 = { new StreamReader(stream01[0]),
                                                   ...
                                                   new StreamReader(stream01[11]),
                                                   new StreamReader(stream01[12]),
                                                   new StreamReader(stream01[13]),
        ...
        private static string[] data01 = { reader01[0].ReadToEnd(),
                                           ...
                                           reader01[8].ReadToEnd(),
                                            ...
                                            reader01[11].ReadToEnd(),
                                            reader01[12].ReadToEnd(),
                                            reader01[13].ReadToEnd(),
        ...
        public string admin_path01 => string.Join("\n", data01[0]);
        public string[] API => data01[1].Split("\n");
        public string[] Chemistry => data01[2].Split("\n");
        public string[] Chemistry01 => data01[3].Split("\n");
        public string Client_Textfile01 => string.Join("\n", data01[4]);
        public string[] cloudinary_com => data01[5].Split("\n");

        public string[] hairstyle_info_01 => data01[6].Split("\n");
        public string[] hairstyle_info_02 => data01[7].Split("\n");
        public string[] Language_Abbreviation => data01[8].Split("\n");
        public string[] Language_Name => data01[9].Split("\n");
