...
namespace E_MauiApp01.SERVICES.FILE_SERVICES.TEXT_FILES
{
    internal class Read_Textfiles
    {
        ...
        public string[] The_Book_of_Enoch => data01[8].Split("\n");
        public string[] The_Book_of_Jubilees => data01[9].Split("\n");
        public string[] The_Bible_KJV => data01[10].Split("\n");
