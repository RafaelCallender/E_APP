        ...
        private static readonly string[] VideoExtensions01 =
{
    ...
    ".asf"
        ...
        public static string[] file_path_data01 = {       @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP\FILES\TEXT\TEXT_SAVED\mytextfile01.txt",
                                                          @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP\FILES\TEXT\TEXT_SAVED\mytextfile02.txt",
                                                          @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP\FILES\TEXT\TEXT_SAVED\mytextfile03.txt",
                                                          @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP\FILES\TEXT\TEXT_SAVED\mytextfile04.txt",
                                                          @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP\FILES\TEXT\TEXT_SAVED\mytextfile05.txt",
                                                          @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP\FILES\TEXT\TEXT_SAVED\mytextfile06.txt",
                                                          @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP\FILES\TEXT\TEXT_SAVED\mytextfile07.txt",
                                                          @"C:\Users\calle\OneDrive\Desktop\PROJECTS\E_APP\E_APP",

        };


        public enum file_path_data01_enum
        {
            question = 0,
            developers = 1,
            bible = 2,
        ...
        private static string[] csfiles = Directory.GetFiles(file_path_data01[(int)file_path_data01_enum.find_cs], "*.cs", SearchOption.AllDirectories);
        private static string[] txtfiles = Directory.GetFiles(file_path_data01[(int)file_path_data01_enum.find_txt], "*.txt", SearchOption.AllDirectories);
        ...
        private static string get_saved_text_files =>string.Join("\n", txtfiles);
        private static string get_saved_cs_files => string.Join("\n", csfiles);
        ...
        public string file_saved(string input,string input01,int file_path)
        {
            ...
            string path = file_path_data01[file_path].Trim();
     ...
     .ToArray();
        ...
        public string find_text_files()
        {

            data01[7] = get_saved_text_files;
            
            return data01[7].Trim();
        }
        public string find_cs_files()
        {
     
                data01[7] = get_saved_cs_files;
