...
namespace E_APP.SERVICES.SQL.SQL_MANAGER.SQL_MANAGER_CLIENTS
{
    internal class Sql_Manager01
    {
        ...
        public enum command_strings
        {
            ...
            find_client_data_using_email = 0,
            find_client_data_using_latitude_and_longitude = 1,
            find_client_data_using_logo = 2,
            find_client_data_using_name = 3,
            find_client_data_using_number = 4,
            insert_client = 5,
        }
    }
}