using E_APP.SERVICES.SQL.SQL_MANAGER.SQL_CLIENTS01_MANAGER;
...
namespace E_APP.SERVICES.SQL.SQL_SERVICES.SQL_CLIENTS_SERVICES
{
    internal class Sql_Client_Services01
    {
        ...
        public bool find_client_email_by_email(string input, out string output)
        {
            ...
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_email_by_email].Parameters.AddWithValue("@username", input);
        ...
        public bool find_client_email_by_phonenumber(string input, out string output)
        {
            ...
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].CommandType = CommandType.StoredProcedure;
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].Parameters.Clear();
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].Parameters.AddWithValue("@client_phonenumber", input);
            using (SqlDataReader reader = Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].ExecuteReader())
            {
                if (reader.Read())
                {
        ...
        public bool find_client_name_by_email(string input, out string output)
        {
            ...
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].CommandType = CommandType.StoredProcedure;
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].Parameters.Clear();
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].Parameters.AddWithValue("@client_email_address", input);
            using (SqlDataReader reader = Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.find_client_phonenumber_by_name].ExecuteReader())
            {
                if (reader.Read())
                {
