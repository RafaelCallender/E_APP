...
{
    internal class Sql_Client_Services01
    {
                                  ...
                                  out string output)
        {
            ...
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_name", input01);
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_email_key", input02);
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_api_key", input03);
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_email_address", input04);
            Sql_Client01_Manager01.cmd[(int)Sql_Client01_Manager01.command_strings.insert_client].Parameters.AddWithValue("@client_phonenumber", input05);
        ...
        public bool find_client_data01_by_email(string input, out string output)
        {
            Sql_Manager01.conn[(int)Sql_Manager01.Connection_strings.Connection01].Open();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_email].CommandType = CommandType.StoredProcedure;
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_email].Parameters.Clear();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_email].Parameters.AddWithValue("@client_email_addres", input);
            using (SqlDataReader reader = Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_email].ExecuteReader())
            {
                if (reader.Read())
                {
                    output = $"{reader["client_data01"].ToString()}";
                    status = true;
                }
                else
                {
        ...
        public bool find_client_data01_by_name(string input, out string output)
        {
            Sql_Manager01.conn[(int)Sql_Manager01.Connection_strings.Connection01].Open();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_name].CommandType = CommandType.StoredProcedure;
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_name].Parameters.Clear();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_name].Parameters.AddWithValue("@client_name", input);
            using (SqlDataReader reader = Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_name].ExecuteReader())
            {
                if (reader.Read())
                {
                    output = $"{reader["client_data01"].ToString()}";
        ...
        public bool find_client_data01_by_phonenumber(string input, out string output)
        {
            Sql_Manager01.conn[(int)Sql_Manager01.Connection_strings.Connection01].Open();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_phonenumber].CommandType = CommandType.StoredProcedure;
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_phonenumber].Parameters.Clear();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_phonenumber].Parameters.AddWithValue("@client_phonenumber", input);
            using (SqlDataReader reader = Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data01_by_phonenumber].ExecuteReader())
            {
                if (reader.Read())
                {
                    output = $"{reader["client_data01"].ToString()}";
        ...
        public bool find_client_zelle_by_name(string input, out string output)
        {
            ...
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_zelle_by_name].Parameters.AddWithValue("@client_namel", input);
        ...
        public bool find_client_data02_by_email(string input, out string output)
        {
            Sql_Manager01.conn[(int)Sql_Manager01.Connection_strings.Connection01].Open();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_email].CommandType = CommandType.StoredProcedure;
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_email].Parameters.Clear();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_email].Parameters.AddWithValue("@client_phonenumber", input);
            using (SqlDataReader reader = Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_email].ExecuteReader())
            {
                if (reader.Read())
                {
                    output = $"{reader["client_data02"].ToString()}";
                    status = true;
                }
                else
                {
        ...
        public bool find_client_data02_by_phonenumber(string input, out string output)
        {
            Sql_Manager01.conn[(int)Sql_Manager01.Connection_strings.Connection01].Open();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_phonenumber].CommandType = CommandType.StoredProcedure;
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_phonenumber].Parameters.Clear();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_phonenumber].Parameters.AddWithValue("@client_phonenumber", input);
            using (SqlDataReader reader = Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_phonenumber].ExecuteReader())
            {
                if (reader.Read())
                {
                    output = $"{reader["client_data02"].ToString()}";
        ...
        public bool find_client_data02_by_name(string input, out string output)
        {
            Sql_Manager01.conn[(int)Sql_Manager01.Connection_strings.Connection01].Open();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_name].CommandType = CommandType.StoredProcedure;
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_name].Parameters.Clear();
            Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_name].Parameters.AddWithValue("@client_name", input);
            using (SqlDataReader reader = Sql_Manager01.cmd[(int)Sql_Manager01.command_strings.find_client_data02_by_name].ExecuteReader())
            {
                if (reader.Read())
                {
                    output = $"{reader["client_data02"].ToString()}";
