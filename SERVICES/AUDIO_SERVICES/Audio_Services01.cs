...
namespace E_APP.SERVICES.AUDIO_SERVICES
{
    internal class Audio_Services01
    {
        ...
        private TaskCompletionSource<string>? stopTcs;
        public async Task<string> start_recording(string folder)
        {
            ...
            stopTcs = new TaskCompletionSource<string>(); // <-- new
            ...
            waveIn.RecordingStopped += (s, e) =>
            {
                ...
                stopTcs.TrySetResult($"✅ Audio saved to:\n{currentFilePath}");
            };

            waveIn.StartRecording();
            data01[0] = "🎙️ Recording started...\n";
            return data01[0];
        }
        public async Task<string> stop_recording()
        {
            if (waveIn == null || stopTcs == null)
            {
                return "Not recording.";
            }

            waveIn.StopRecording();
            return await stopTcs.Task; // <-- waits until file is fully saved
        }
