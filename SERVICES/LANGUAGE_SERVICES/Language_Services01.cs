...
namespace E_APP.SERVICES.LANGUAGE_SERVICES
{
                ...
                Headers =
    {
        ...
        private void update_language_sql()
        {
            ...
            {
               results= Sql_Serv01.insert_language(language[i], code[i],out output);
            }
            if(results)
            {
        ...
        public string pick_language_using_sql(string input) //needs work 
        {
            ...
            results = Sql_Serv01.find_code_using_code(input,out output);

            results  = Sql_Serv01.find_code_using_language(input,out output);
        ...
        public async Task<string> Translate_using_Ai(string input, string input01)
        {
            ...
            data01[0] = await Ai_Text_To_T06.text_to_text_translate01(detct_lang.Trim(), select_lang.Trim(), input01.Trim());
            return data01[0];
        }
    }
}