    ...
    internal class Ai_Text_To_Text04
    {
        ...
        public async Task<string> text_to_text_content01(string input, Action? chunkLoader)
        {
           ...
           string textfile_content = string.Empty;
            ...
            string prompt = $"""
You are a **Book of Jubilees scholar and text interpreter**.
You will answer questions *only* using the Book of Jubilees text and saved text provided below.

### RULES
1. Do **NOT** use any outside knowledge other than the Book of Jubilees Text and Saved Text.
...
4. When quoting scripture, include chapter and verse if present in the Book of Jubilees text.
...
### SAVED TEXT
{File_Helper01.file_path_data01[(int)File_Helper01.file_path_data01_enum.jubilees].Trim()}
