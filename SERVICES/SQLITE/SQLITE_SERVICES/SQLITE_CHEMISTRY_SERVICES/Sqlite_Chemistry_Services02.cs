...
namespace E_APP.SERVICES.SQLITE.SQLITE_SERVICES.SQLITE_CHEMISTRY_SERVICES
{
    internal class Sqlite_Chemistry_Services02
    {
        ...
        public async Task<string> insert_element(int input01, string input02, string input03,
        ...
        public async Task<string> find_element_using_symbol(string input)
        {
            ...
            if (data03 != null)
            {
                data01[1] = $"{data03.atomic_number.ToString()}\n" +
                            $"{data03.element_name}\n" +
        ...
        public async Task<string> find_element_using_name(string input)
        {
            ...
            if (data04 != null)
            {
                data01[2] = $"{data04.atomic_number.ToString()}\n" +
